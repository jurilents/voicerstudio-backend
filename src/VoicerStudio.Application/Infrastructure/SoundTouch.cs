...
public sealed class SoundTouch : IDisposable
{
    ...
    public uint AvailableSampleCount
    {
        get
        {
            lock (SyncRoot) { return NativeMethods.NumSamples(handle); }
        }
    }
    ...
    public uint UnprocessedSampleCount
    {
        get
        {
            lock (SyncRoot) { return NativeMethods.NumUnprocessedSamples(handle); }
        }
    }
    ...
    public int IsEmpty
    {
        get
        {
            lock (SyncRoot) { return NativeMethods.IsEmpty(handle); }
        }
    }
    ...
    public uint Channels
    {
        set
        {
            lock (SyncRoot) { NativeMethods.SetChannels(handle, value); }
        }
    }
    ...
    public uint SampleRate
    {
        set
        {
            lock (SyncRoot) { NativeMethods.SetSampleRate(handle, value); }
        }
    }
    ...
    public float Tempo
    {
        set
        {
            lock (SyncRoot) { NativeMethods.SetTempo(handle, value); }
        }
    }
    ...
    public float TempoChange
    {
        set
        {
            lock (SyncRoot) { NativeMethods.SetTempoChange(handle, value); }
        }
    }
    ...
    public float RateChange
    {
        set
        {
            lock (SyncRoot) { NativeMethods.SetRateChange(handle, value); }
        }
    }
    ...
    public float Pitch
    {
        set
        {
            lock (SyncRoot) { NativeMethods.SetPitch(handle, value); }
        }
    }
    ...
    public float PitchOctaves
    {
        set
        {
            lock (SyncRoot) { NativeMethods.SetPitchOctaves(handle, value); }
        }
    }
    ...
    public float PitchSemiTones
    {
        set
        {
            lock (SyncRoot) { NativeMethods.SetPitchSemiTones(handle, value); }
        }
    }
...
public sealed class BPMDetect : IDisposable
{
    ...
    public float Bpm
    {
        get
        {
            lock (SyncRoot) { return NativeMethods.BpmGet(handle); }
        }
    }
